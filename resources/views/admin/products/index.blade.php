        ...
        <table class="table table-striped" >
          ...
          <tbody>
            ...
            <tr>
              ...
              white-space: pre-wrap; 
              white-space: -moz-pre-wrap; 
              white-space: -pre-wrap; width:300px">{!! str_limit($product->description, 650, ' ...') !!}</td>
              <td style="width:40px"> 
                
                <div class="row">
                    <a href="{{route('shops', $product->id)}}" class="btn btn-secondary btn-fw">View</a>
                </div>
                <br>
                <div class="row">
                    <a href="{{route('product.edit', $product->id)}}" class="btn btn-warning btn-fw">Edit</a>
                </div>
                <br>
                <div class="row">
